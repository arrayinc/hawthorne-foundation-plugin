<div class="wrap">
    ...
    <form action="options.php" method="post">
        ...
        <label for="spring_application_date_start">Spring Semester Application Start Date</label>
        ...
        <label for="spring_application_date_end">Spring Semester Application End Date</label>
        ...
        <label for="fall_application_date_start">Fall Semester Application Start Date</label>
        ...
        <label for="fall_application_date_end">Fall Semester Application end Date</label>
